const char font6x8_ascii[128][6] = {
    ...
    {0x00, 0x22, 0x10, 0x08, 0x04, 0x22},  // 0x25 (%)
    ...
    {0x00, 0x3C, 0x0C, 0x10, 0x0C, 0x3C},  // 0x6D (m)
    {0x00, 0x00, 0x38, 0x04, 0x04, 0x38},  // 0x6E (n)
    {0x00, 0x00, 0x18, 0x24, 0x24, 0x18},  // 0x6F (o)
    {0x00, 0x00, 0x7E, 0x12, 0x12, 0x0C},  // 0x70 (p)
    {0x00, 0x00, 0x0C, 0x12, 0x12, 0x7E},  // 0x71 (q)
    {0x00, 0x04, 0x38, 0x04, 0x04, 0x08},  // 0x72 (r)
    {0x00, 0x00, 0x04, 0x2A, 0x2A, 0x10},  // 0x73 (s)
    {0x00, 0x00, 0x04, 0x3E, 0x24, 0x24},  // 0x74 (t)
    ...
    {0x00, 0x00, 0x44, 0x28, 0x18, 0x04},  // 0x79 (y)

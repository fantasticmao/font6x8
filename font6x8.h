const char font6x8_ascii[128][6] = {
    ...
    {0x00, 0x11, 0x08, 0x04, 0x02, 0x11},  // 0x25 (%)
    {0x00, 0x14, 0x2A, 0x2A, 0x14, 0x28},  // 0x26 (&)
    ...
    {0x00, 0x10, 0x08, 0x04, 0x02, 0x01},  // 0x2F (/)
    ...
    {0x00, 0x00, 0x1C, 0x2A, 0x29, 0x10},  // 0x36 (6)
    {0x00, 0x00, 0x01, 0x39, 0x05, 0x03},  // 0x37 (7)
    {0x00, 0x00, 0x1A, 0x25, 0x25, 0x1A},  // 0x38 (8)
    {0x00, 0x00, 0x02, 0x25, 0x15, 0x0E},  // 0x39 (9)
    ...
    {0x00, 0x00, 0x18, 0x20, 0x20, 0x1F},  // 0x4A (J)
    ...
    {0x00, 0x21, 0x31, 0x29, 0x25, 0x23},  // 0x5A (Z)
    {0x00, 0x00, 0x3F, 0x21, 0x21, 0x00},  // 0x5B ([)
    {0x00, 0x01, 0x02, 0x04, 0x08, 0x10},  // 0x5C (\)
    ...
    {0x00, 0x04, 0x04, 0x3F, 0x05, 0x05},  // 0x66 (f)

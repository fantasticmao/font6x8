const char font6x8_ascii[128][6] = {
    ...
    {0x00, 0x24, 0xCB, 0x52, 0x24, 0x00},  // 0x24 ($)
    {0x00, 0x12, 0x08, 0x04, 0x12, 0x00},  // 0x25 (%)
    {0x00, 0x14, 0x2A, 0x16, 0x20, 0x00},  // 0x26 (&)
    {0x00, 0x00, 0x00, 0x07, 0x00, 0x00},  // 0x27 (')
    {0x00, 0x00, 0x00, 0x3E, 0x41, 0x00},  // 0x28 (()
    {0x00, 0x00, 0x00, 0x41, 0x3E, 0x00},  // 0x29 ())
    {0x00, 0x08, 0x1C, 0x08, 0x1C, 0x08},  // 0x2A (*)
    {0x00, 0x08, 0x08, 0x3E, 0x08, 0x08},  // 0x2B (+)
    {0x00, 0x00, 0x00, 0x20, 0x10, 0x00},  // 0x2C (,)
    {0x00, 0x08, 0x08, 0x08, 0x08, 0x08},  // 0x2D (-)
    {0x00, 0x00, 0x00, 0x10, 0x00, 0x00},  // 0x2E (.)
    {0x00, 0x10, 0x08, 0x04, 0x02, 0x00},  // 0x2F (/)
